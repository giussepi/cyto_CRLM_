...
if __name__ == '__main__':
    ...
    #testhis = HisImage(r'N:/CLRM/',r'2016-01-13 16.44.33_1_Carlos')    
    #testhis.ExtractandUploadAll()
    #testhis.ExtractImage(1)
    #testhis.ExtractandUpload(1)
    #testhis.ExtractandUpload_bak()